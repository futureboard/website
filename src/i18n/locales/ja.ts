...
export const ja: TranslationKeys = {
  ...
  dl_title: "製品の入手",
  dl_lead:
    "現在テスト開発中の段階ですが、構造を体験されたい方向けにWindowsビルドを公開しています。一部不安定な箇所がございますのでご了承ください。",
  dl_released: "2026年6月リリース",
  dl_all_releases: "GitHubで全ビルドを見る →",

  dl_win_desc:
    "日々開発とテストを行っている環境です。細かなバグが残る可能性がありますが、主要なタイムライン、ミキサー、ピアノロール機能は動作します。",
  dl_mac_desc:
    "未対応。GPUIはすでにmacOSをサポートしているため、Windows版が安定し次第Mac環境向けのコンパイルに着手します。GitHubでのご支援をお待ちしています。",
  dl_linux_desc:
    "未対応。macOS版の後に対応予定。Rust製コードのため元々クロスプラットフォーム設計ですが、インストーラ作成と音声デバイスの最適化が必要です。",
  ...
  dl_changelog_older_desc:
    "内部テスト用ビルド。描写エンジンをGPUIへ移植する過程における試行錯誤の初期履歴です。",
